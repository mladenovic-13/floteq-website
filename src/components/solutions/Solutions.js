  ...
  return (
    <section className="pt-4 lg:pt-10">
      <div>
        ...
        <p className=" mx-auto mt-2 text-lg text-center ">KNOW MORE. DO MORE.</p>
      </div>

      <div className="mx-auto w-5/6 mt-2 lg:mt-0">
        <div id="data" className="grid mb-6 lg:my-16 lg:gap-8 lg:grid-cols-2 lg:place-items-center">
          <div>
            <h3 className="text-center lg:text-left text-2xl font-bold tracking-tight sm:text-3xl ">
        ...
        <div>
          <div
            id="autoData"
            className="grid mb-6 lg:my-16  lg:gap-8 lg:grid-cols-2 lg:items-center"
          >
      ...
      <div id="chs" className="mx-auto w-5/6">
        <div className="grid mb-6 lg:my-16 lg:gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <h3 className="text-center lg:text-left text-2xl font-bold tracking-tight sm:text-3xl ">
        ...
        <div>
          <div className="lg:my-16 mb-6 grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div className="lg:col-start-2">
              <h3 className="text-center lg:text-left text-2xl font-bold tracking-tight sm:text-3xl ">
                RUGGEDISED HARDWARE
                <br />
