      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Driven</span>
          </span>{' '}
          by performance
        </h2>
        <p className="text-base text-gray-700 md:text-lg">
          Every Pour counts! Every single one. Venues have diffrent bars for diffrent reasons. Some
          serve craft beer and wine, some spirits and some a combination of both. When you know how
          your beverage is poured, consumed and how it performs it changes the game
        </p>
      </div>
      <div className="relative w-full p-px mx-auto mb-4 overflow-hidden transition-shadow duration-300 border rounded lg:mb-8 lg:max-w-4xl group hover:shadow-xl">
        ...
        <div className="relative flex flex-col items-center h-full py-10 duration-300 bg-white rounded-sm transition-color sm:items-stretch sm:flex-row">
          <div className="px-12 py-8 text-center">
            <h6 className="text-4xl font-bold text-deep-purple-accent-400 sm:text-5xl">63%</h6>
            <p className="text-center md:text-base">Average Waste Eliminated</p>
          </div>
          ...
          <div className="px-12 py-8 text-center">
            <h6 className="text-4xl font-bold text-deep-purple-accent-400 sm:text-5xl">4Mil</h6>
            <p className="text-center md:text-base">Liters Monitored</p>
          </div>
        </div>
      </div>
      <p className="mx-auto mb-4 text-gray-600 sm:text-center lg:max-w-2xl lg:mb-6 md:px-16">
        Manage any and every venue from antwhere at all{' '}
      </p>
    </div>
  );
};
